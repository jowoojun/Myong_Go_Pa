...
var countries = ["폴주니어", "산골식당", "돈코복코","153포인츠", "토마토도시락", "이삭토스트", 
                 "두부쑤는집", "호접몽", "솥닭", "항아리보쌈", "하야미", "마더스핑거", 
                 "종이밥", "도스마스", "스테프핫도그", "평안도찹쌀순대", "강한남자들의 고기집", "전설의 곱창",
                 "우림 삼겹*곱돌찌개", "고기파티", "따뜻한 밥상", "춘천닭갈비", "화미가", "그대덕애",
                 "복이자카야", "안성깍두기", "통통치킨"];
